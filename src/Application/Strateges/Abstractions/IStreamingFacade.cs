...
public interface IStreamingFacade
{
    ...
    Task<PageDto<SourcePlaylistDto>> GetPlaylistsAsync(StreamingService platform, PagedRequest pagedRequest, string accessToken);
    ...
    Task<SourcePlaylistDto> CreatePlaylistAsync(StreamingService platform, string name, string accessToken, string? description = null, bool isPublic = false);
